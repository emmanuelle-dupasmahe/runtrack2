...
try {
    ...
    // Requête SQL 
    $sql = "SELECT id, nom, id_etage AS étage, capacite AS capacité FROM salles ORDER BY capacite ASC;";
    $stmt = $pdo->query($sql);
    ...
    if ($salles) {
        ...
        echo '<!DOCTYPE html>
              ...
              <head>
                  ...
                  <title>Ensemble des capacités des salles par ordre croissant</title>
                  <style>
              ...
              <body>
                  <h1>Ensemble des capacités des salles par ordre croissant</h1>
                  <table>';
